...
//values (changebles)
const mongoDBConnectionString = 'REPLACE WITH YOUR MONGODB CONNECTION STRING'; //connection string for mongodb | eg: mongodb+srv://myfirstdb:MyPass$156@cluster0.gfv8vjt.mongodb.net/collections
...
const ROOM = "REPLACE WITH YOUR DESIRED NAME"; //socket io room name eg:- admins
const PASSWORD = "REPLACE WITH HASHED PASSWORD ACCORDING TO (hashMethod)"; //socket io hashed (sha256) password (mightyxv15)
const hashMethod = 'HASH METHOD'; //hash method eg:- sha256
